...
export const mergeWithBuildingData = (apiData: VillageData, buildingJson: VillageData): VillageData  => {
  ...
  return {
    ...
    homeVillage: {
      ...
      townHallUpgrade: buildingJson.homeVillage.townHallUpgrade,
      townHallWeaponLevel: buildingJson.homeVillage.townHallWeaponLevel,
      townHallWeaponUpgrade: buildingJson.homeVillage.townHallWeaponUpgrade,
